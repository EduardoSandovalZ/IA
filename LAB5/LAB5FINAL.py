...
# Agregar las rectas de decisión
x_vals = np.array([-2, 8])
y_vals = -(perceptron.weights[0][0] / perceptron.weights[1][0]) * x_vals - perceptron.weights[2][0] / perceptron.weights[1][0]
plt.plot(x_vals, y_vals, '--', c='C0')
y_vals = -(perceptron.weights[0][1] / perceptron.weights[1][1]) * x_vals - perceptron.weights[2][1] / perceptron.weights[1][1]
plt.plot(x_vals, y_vals, '--', c='C1')
